...
(function(){
  ...
  function buildSVG(cfg, order, solved){
    ...
    // (info) maksimalna visina visećih za dalje potrebe
  ...
  function render(cfg, order, solved){
    ...
    // 2) Mirror u #elements (skriven) za PDF snapshot
    var mirror = $('#elements');
    if(mirror){
      mirror.innerHTML = '';
      // koristimo novi SVG da izbegnemo reflow iz prikazanog
  ...
  // Expose mini API za ponudu (ako zatreba ručno)
  (window.App = window.App || {}).FrontView = {
